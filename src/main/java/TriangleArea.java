...
import MyException.MyExceptionNotTriangle;
import MyException.MyExceptionSegment;
public class TriangleArea {
    ...
    public static String areaTriangle(String aa, String bb, String cc) throws MyException {
